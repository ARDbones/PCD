...
I lock di Java sono rientranti, cioè un thread può acquisire e rilasciare più volte il lock su uno stesso oggetto senza temere di finire in deadlock con se stesso.
